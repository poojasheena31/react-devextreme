...
var types, type, isBoolean, isExponential, isDate, isDefined, isFunction, isString, isNumeric, isObject, isEmptyObject, isPlainObject, isPrimitive, isWindow, isRenderer, isPromise, isDeferred, isEvent, m_type_default;
var init_m_type = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_type.js"() {
    types = {
      "[object Array]": "array",
      "[object Date]": "date",
...
var noop, getConsoleMethod, logger, debug, m_console_default;
var init_m_console = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_console.js"() {
    init_type();
    noop = function() {
    };
...
var m_errors_default;
var init_m_errors = __esm({
  "node_modules/devextreme/esm/__internal/core/m_errors.js"() {
    init_error();
    m_errors_default = error_default({
...
var init_errors = __esm({
  "node_modules/devextreme/esm/core/errors.js"() {
    init_m_errors();
    errors_default = m_errors_default;
  }
});

// node_modules/devextreme/esm/__internal/core/m_class.js
var wrapOverridden, clonePrototype, redefine, include, subclassOf, abstract, classImpl, m_class_default;
var init_m_class = __esm({
  "node_modules/devextreme/esm/__internal/core/m_class.js"() {
    init_errors();
    init_type();
...
var init_m_dependency_injector = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_dependency_injector.js"() {
    init_class();
    init_extend();
    init_iterator();
...
var dependency_injector_default;
var init_dependency_injector = __esm({
  "node_modules/devextreme/esm/core/utils/dependency_injector.js"() {
    init_m_dependency_injector();
    dependency_injector_default = injector;
  }
});

// node_modules/devextreme/esm/__internal/core/utils/m_variable_wrapper.js
var variableWrapper;
var init_m_variable_wrapper = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_variable_wrapper.js"() {
    init_console();
    init_dependency_injector();
    variableWrapper = dependency_injector_default({
      isWrapped: function() {
        return false;
      },
...
var init_variable_wrapper = __esm({
  "node_modules/devextreme/esm/core/utils/variable_wrapper.js"() {
    init_m_variable_wrapper();
    variable_wrapper_default = variableWrapper;
  }
});

// node_modules/devextreme/esm/__internal/core/utils/m_object.js
var orderEach, getDeepCopyTarget, legacyAssign, newAssign, deepExtendArraySafe;
var init_m_object = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_object.js"() {
    init_type();
    ...
    legacyAssign = function(target, property, value, extendComplexObject, assignByReference, shouldCopyUndefined) {
    ...
    newAssign = function(target, property, value, extendComplexObject, assignByReference, shouldCopyUndefined) {
    ...
    deepExtendArraySafe = function(target, changes, extendComplexObject, assignByReference, shouldCopyUndefined, useNewAssign) {
      let prevValue;
      let newValue;
...
var Callback, Callbacks, m_callbacks_default;
var init_m_callbacks = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_callbacks.js"() {
...
var config, normalizeToJSONString, deprecatedFields, configMethod, m_config_default;
var init_m_config = __esm({
  "node_modules/devextreme/esm/__internal/core/m_config.js"() {
    init_errors();
    init_extend();
    config = {
...
var init_m_template_engine_registry = __esm({
  "node_modules/devextreme/esm/__internal/core/templates/m_template_engine_registry.js"() {
    init_errors();
    init_type();
    templateEngines = {};
...
var init_set_template_engine = __esm({
  "node_modules/devextreme/esm/common/set_template_engine.js"() {
    init_m_set_template_engine();
  }
});
...
var init_config2 = __esm({
  "node_modules/devextreme/esm/core/config.js"() {
    init_common();
    config_default2 = config_default;
  }
});

// node_modules/devextreme/esm/core/guid.js
var guid_default2;
var init_guid2 = __esm({
  "node_modules/devextreme/esm/core/guid.js"() {
    init_common();
    guid_default2 = guid_default;
  }
});

// node_modules/devextreme/esm/__internal/core/utils/m_common.js
var uiLayerInitialized, ensureDefined, executeAsync, delayedFuncs, delayedNames, delayedDeferreds, executingName, deferExecute, deferRender, deferUpdate, deferRenderer, deferUpdater, findBestMatches, match, splitPair, normalizeKey, denormalizeKey, pairToObject, getKeyHash, escapeRegExp, applyServerDecimalSeparator, noop2, asyncNoop, grep, compareArrays, compareObjects, DEFAULT_EQUAL_BY_VALUE_OPTS, compareByValue, equalByValue, m_common_default;
var init_m_common = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_common.js"() {
    init_config2();
    init_guid2();
    init_data();
    ...
    init_iterator();
    init_type();
    uiLayerInitialized = new Deferred();
    ...
    findBestMatches = (targetFilter, items, mapFn) => {
      const bestMatches = [];
      let maxMatchCount = 0;
...
var ownerDocumentStyleSheet, sheetHashes, styleSheetHashes;
var init_m_shadow_dom = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_shadow_dom.js"() {
    init_config2();
    ownerDocumentStyleSheet = null;
    sheetHashes = /* @__PURE__ */ new WeakMap();
    styleSheetHashes = /* @__PURE__ */ new WeakMap();
  }
});
...
var nativeDOMAdapterStrategy, domAdapter, m_dom_adapter_default;
var init_m_dom_adapter = __esm({
  "node_modules/devextreme/esm/__internal/core/m_dom_adapter.js"() {
    init_common2();
    init_dependency_injector();
    init_shadow_dom();
    ...
    domAdapter = dependency_injector_default(nativeDOMAdapterStrategy);
    m_dom_adapter_default = domAdapter;
  }
});

// node_modules/devextreme/esm/core/dom_adapter.js
var dom_adapter_default;
var init_dom_adapter = __esm({
  "node_modules/devextreme/esm/core/dom_adapter.js"() {
    init_m_dom_adapter();
    dom_adapter_default = domAdapter;
  }
});

// node_modules/devextreme/esm/__internal/core/utils/m_window.js
var hasWindowValue, hasWindow, windowObject, getWindow, setWindow, hasProperty, defaultScreenFactorFunc, getCurrentScreenFactor, getNavigator, m_window_default;
var init_m_window = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_window.js"() {
    init_dom_adapter();
    ...
    setWindow = (newWindowObject, hasWindow2) => {
...
var callbacks, subscribeReady, readyCallbacks, readyCallbacksModule, m_ready_callbacks_default;
var init_m_ready_callbacks = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_ready_callbacks.js"() {
    init_dom_adapter();
    init_call_once();
    init_dependency_injector();
    ...
    readyCallbacksModule = dependency_injector_default(readyCallbacks);
    m_ready_callbacks_default = readyCallbacksModule;
  }
});

// node_modules/devextreme/esm/core/utils/ready_callbacks.js
var ready_callbacks_default;
var init_ready_callbacks = __esm({
  "node_modules/devextreme/esm/core/utils/ready_callbacks.js"() {
    init_m_ready_callbacks();
    ready_callbacks_default = readyCallbacksModule;
  }
});

// node_modules/devextreme/esm/__internal/core/m_memorized_callbacks.js
var MemorizedCallbacks;
var init_m_memorized_callbacks = __esm({
  "node_modules/devextreme/esm/__internal/core/m_memorized_callbacks.js"() {
    init_callbacks();
    init_iterator();
...
var memorized_callbacks_default;
var init_memorized_callbacks = __esm({
  "node_modules/devextreme/esm/core/memorized_callbacks.js"() {
    init_m_memorized_callbacks();
    memorized_callbacks_default = MemorizedCallbacks;
  }
});
...
var init_event_registrator_callbacks = __esm({
  "node_modules/devextreme/esm/common/core/events/core/event_registrator_callbacks.js"() {
    ...
    event_registrator_callbacks_default = new memorized_callbacks_default();
  }
});
...
var init_m_hook_touch_props = __esm({
  "node_modules/devextreme/esm/__internal/events/core/m_hook_touch_props.js"() {
...
// node_modules/devextreme/esm/common/core/events/core/hook_touch_props.js
var init_hook_touch_props = __esm({
  "node_modules/devextreme/esm/common/core/events/core/hook_touch_props.js"() {
    init_m_hook_touch_props();
  }
});

// node_modules/devextreme/esm/__internal/events/utils/m_event_target.js
var getEventTarget;
var init_m_event_target = __esm({
  "node_modules/devextreme/esm/__internal/events/utils/m_event_target.js"() {
...
// node_modules/devextreme/esm/common/core/events/utils/event_target.js
...
var EMPTY_EVENT_NAME, NATIVE_EVENTS_TO_SUBSCRIBE, NATIVE_EVENTS_TO_TRIGGER, NO_BUBBLE_EVENTS, forcePassiveFalseEventNames, EVENT_PROPERTIES;
var init_m_consts = __esm({
  "node_modules/devextreme/esm/__internal/events/core/m_consts.js"() {
...
var window2, elementDataMap, guid, skipEvent, special, eventsEngine, passiveEventHandlersSupported, contains, beforeSetStrategy, afterSetStrategy, m_events_engine_default;
var init_m_events_engine = __esm({
  "node_modules/devextreme/esm/__internal/events/core/m_events_engine.js"() {
    ...
    m_events_engine_default = eventsEngine;
  }
});

// node_modules/devextreme/esm/common/core/events/core/events_engine.js
var init_events_engine = __esm({
  "node_modules/devextreme/esm/common/core/events/core/events_engine.js"() {
    init_m_events_engine();
  }
});

// node_modules/devextreme/esm/__internal/core/utils/m_html_parser.js
var isTagName, tagWrappers, parseHTML, isTablePart;
var init_m_html_parser = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_html_parser.js"() {
    init_dom_adapter();
    isTagName = /<([a-z][^/\0>\x20\t\r\n\f]+)/i;
    tagWrappers = {
...
var init_m_size = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_size.js"() {
    ...
    setWidth = (el, value) => implementationsMap.setWidth(el, value);
    getHeight = (el) => implementationsMap.getHeight(el);
    setHeight = (el, value) => implementationsMap.setHeight(el, value);
...
var init_m_element_data = __esm({
  "node_modules/devextreme/esm/__internal/core/m_element_data.js"() {
    init_events_engine();
    init_dom_adapter();
    init_memorized_callbacks();
    dataMap = /* @__PURE__ */ new WeakMap();
    strategyChanging = new memorized_callbacks_default();
...
var _normalize, _upperCaseFirst, _chop, dasherize, underscore, camelize, humanize, titleize, DIGIT_CHARS, captionize, m_inflector_default;
var init_m_inflector = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_inflector.js"() {
    init_iterator();
...
var jsPrefixes, cssPrefixes, getStyles, forEachPrefixes, styleProp, stylePropPrefix, pxExceptions, normalizeStyleProp, setDimensionProperty, setWidth2, setHeight2, setStyle;
var init_m_style = __esm({
  "node_modules/devextreme/esm/__internal/core/utils/m_style.js"() {
    init_dom_adapter();
    init_call_once();
    init_inflector();
    ...
    setWidth2 = function(elements, value) {
      setDimensionProperty(elements, "width", value);
    };
    setHeight2 = function(elements, value) {
...
var window4, renderer, initRender, repeatMethod, setAttributeValue, appendElements, setCss, isVisible, emptyArray, rendererWrapper, m_renderer_base_default;
var init_m_renderer_base = __esm({
  "node_modules/devextreme/esm/__internal/core/m_renderer_base.js"() {
    init_dom_adapter();
    init_element_data();
    init_html_parser();
...
var init_renderer_base = __esm({
  "node_modules/devextreme/esm/core/renderer_base.js"() {
    init_m_renderer_base();
  }
});

// node_modules/devextreme/esm/__internal/core/m_renderer.js
var renderer2;
var init_m_renderer = __esm({
  "node_modules/devextreme/esm/__internal/core/m_renderer.js"() {
    init_renderer_base();
    renderer2 = m_renderer_base_default.get();
  }
});
...
var EventsStrategy;
var init_m_events_strategy = __esm({
  "node_modules/devextreme/esm/__internal/core/m_events_strategy.js"() {
    init_callbacks();
    init_iterator();
    init_type();
...
//# sourceMappingURL=chunk-ZZSK5CFD.js.map
