...
declare const TreeView: <TItem = any, TKey = any>(props: ReplaceFieldTypes<Properties<TItem, TKey>, ITreeViewOptionsNarrowedEvents<TItem, TKey>> & IHtmlOptions & {
    ...
    onItemsChange?: ((value: Array<any | dxTreeViewItem>) => void) | undefined;
} & {
    children?: React.ReactNode;
} & {
    ref?: React.Ref<TreeViewRef<TItem, TKey>> | undefined;
}) => ReactElement | null;
