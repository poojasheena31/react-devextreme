...
declare const FieldAddons: ((props: IFieldAddonsProps) => React.FunctionComponentElement<React.PropsWithChildren<{
    afterTemplate?: template | ((data: any, element: any) => string | any) | undefined;
    beforeTemplate?: template | ((data: any, element: any) => string | any) | undefined;
    afterRender?: ((...params: any) => React.ReactNode) | undefined;
    afterComponent?: React.ComponentType<any> | undefined;
    beforeRender?: ((...params: any) => React.ReactNode) | undefined;
    beforeComponent?: React.ComponentType<any> | undefined;
} & {
    children?: React.ReactNode;
} & {
    elementDescriptor: import("./core/configuration/react/element").IElementDescriptor;
...
export { SelectBox, ISelectBoxOptions, SelectBoxRef, Animation, IAnimationProps, At, IAtProps, BoundaryOffset, IBoundaryOffsetProps, Button, IButtonProps, Collision, ICollisionProps, DropDownOptions, IDropDownOptionsProps, FieldAddons, IFieldAddonsProps, From, IFromProps, Hide, IHideProps, Item, IItemProps, My, IMyProps, Offset, IOffsetProps, Options, IOptionsProps, Position, IPositionProps, Show, IShowProps, To, IToProps, ToolbarItem, IToolbarItemProps };
